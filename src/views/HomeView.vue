<template>
  <main class="container text-white ">
    <div class="pt-4 mb-8 relative">
      ...
      > 
        <li v-for="searchResult in weatherSearchResults" :key="searchResult.id"
    ...
    const getSearchResults = () => {
      ...
      queryTimeout.value = setTimeout(async () => {
        if (searchQuery.value !== '') {
          const result  = await axios.get(`https://api.mapbox.com/geocoding/v5/mapbox.places/${searchQuery.value}.json?access_token=${weatherAPIKey}&types=place`
          );
